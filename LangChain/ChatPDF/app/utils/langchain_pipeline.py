    ...
    def generate(self, context: str, query: str, description: str) -> str:
        ...
        try:
            prompt = f"""Based on the following context from PDF documents, answer the user's question.
                        If the answer cannot be found in the context, say so clearly. Follow the instructions given in the theme. 
                        Identify the theme of the chat and answer the user in the similar mood. 
                        Note: 'User may ask the response generated by you in a specific format in the theme. 
                        Make sure to follow that specific formatting.' 
